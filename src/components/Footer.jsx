...
import ellipis1 from "../assets/images/foot-ellipis1.svg";
import ellipis2 from "../assets/images/foot-ellipis2.svg";
const Footer = () => {
    const y = new Date();
    const year = y.getFullYear();
    return (
        <div className='bg-black overflow-hidden relative'>
            <img className='absolute bottom-0 left-0 z-0' src={ellipis1} alt="ellipis" />
            <img className='absolute top-[10%] right-0 z-0' src={ellipis2} alt="ellipis" />
            <div className="max-w-[1140px] mx-auto px-3 relative z-[2]">
                <div className="flex flex-wrap flex-row -mx-3 pt-[64px] pb-[40px]">
                    <div className="md:w-6/12 sm:w-6/12 w-full lg:w-5/12 px-3">
                        <img className='max-w-[210px]' src={logo} alt="logo" />
                        <p className='opacity-80 max-w-[369px] font-Inter font-medium text-white text-[14px] sm:text-[16px] leading-[25px] pt-4 pb-6'>En Exclusive Games somos un equipo apasionado de personas dedicadas al desarrollo de multiplataformas para juegos de azar</p>
                        <div className="flex gap-3">
                            <a className='hover:-translate-y-2 duration-300' href="https://www.instagram.com/" target='_blank'><img src={insta} alt="insta" /></a>
                            <a className='hover:-translate-y-2 duration-300' href="https://www.facebook.com/" target='_blank'><img src={fb} alt="fb" /></a>
                            <a className='hover:-translate-y-2 duration-300' href="https://www.linkedin.com/" target='_blank'><img src={linkdin} alt="linkdin" /></a>
                        </div>
                    </div>
                    <div className="md:w-3/12 sm:w-6/12 max-lg:pt-[30px] lg:w-2/12 px-3 pt-[10px]">
                        <ul className='m-0 p-0'>
                            ...
                            <li className=' pt-[14px]'><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80 hover:opacity-100 duration-300'>Misión</a></li>
                            <li className=' pt-[14px]'><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80 hover:opacity-100 duration-300'>Tragamonedas</a></li>
                            <li className=' pt-[14px]'><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80 hover:opacity-100 duration-300'>Por qué elegirnos</a></li>
                            <li className=' pt-[14px]'><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80 hover:opacity-100 duration-300'>Ofertas</a></li>
                        </ul>
                    </div>
                    <div className="md:w-3/12 sm:w-6/12 max-lg:pt-[30px]  lg:w-2/12 px-3 pt-[10px]">
                        <ul className='m-0 p-0'>
                            <li className='text-white font-bold font-Inter text-[16px] leading-[25px] pb-4'>Atención al cliente</li>
                            <li><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80'>¿Necesitas ayuda?</a></li>
                            <li className=' pt-[14px]'><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80 hover:opacity-100 duration-300'>política de privacidad</a></li>
                            <li className=' pt-[14px]'><a href="#" className='font-Inter font-medium leading-[25px] text-[13px] sm:text-[16px] text-white opacity-80 hover:opacity-100 duration-300'>Términos de servicio</a></li>
                        </ul>
                    </div>
                    <div className="md:w-4/12 sm:w-6/12 max-lg:pt-[30px]  lg:w-3/12 px-3 pt-[10px]">
                        <ul className='m-0 p-0'>
                            ...
                            <li><a href="https://mail.google.com/mail/u/0/#inbox" target='_blank' className='font-Inter font-medium leading-[25px] text-[16px] text-white opacity-80 flex gap-2 items-center hover:opacity-100 duration-300'><span><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="w-full py-5 border-t border-[#191919]">
                <p className='text-center text-white text-[16px] opacity-50 font-Inter relative z-[2] font-medium leading-[25px]'>© Juegos exclusivos - Todos los derechos reservados {year}</p>
            </div>
        </div>
    )
}
